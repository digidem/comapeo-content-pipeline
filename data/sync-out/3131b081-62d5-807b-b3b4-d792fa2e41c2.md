---
id: "revisando-uma-observacao"
title: Revisando uma Observação
slug: "/revisando-uma-observacao"
sidebar_label: Revisando uma Observação
pagination_label: Revisando uma Observação
custom_edit_url: "https://github.com/digidem/comapeo-docs/edit/main/docs/pt/docs/30-reviewing-observations-tracks/revisando-uma-observacao.md"
source: notion
notion_page_id: "3131b081-62d5-807b-b3b4-d792fa2e41c2"
notion_last_edited_time: "2026-04-22T03:58:00.000Z"
content_hash: "sha256:54f08b992ba10ea668fb0ce6f99a9065774d5cc651d2dbad06b0df860bf2284d"
status: draft
locale: pt
...
:::note 💡 Dica
É possível abrir uma observação para revisão selecionando-a no ![app-icon-map](assets/c3a90bf1bbc7f33b79ebc8060e2591c37c754808d7c30e3f9b9c27848ae5c11a.png) Mapa ou a partir da    ![app-icon-comapeo-observation-list](assets/7c21b40338d78f5d968200f5691ad728105ded9078c76d63513cb934f75f1dc9.png) Lista de Observações.
:::
...
![app-icon-comapeo-validated](assets/40312d1ed97f2d34a239df3607d553b3ec114c6e152b3d965f83622f610f41c9.jpg) Os metadados **validados** também exibirão precisão, altitude, precisão da altitude e velocidade.

![app-icon-comapeo-unvalidated](assets/ce98428d7b5a95769e79f2d5d6b604c49080d6a44cddc3d5675343022a06635f.jpg) Os metadados **não validados** exibirão *“ Esses dados foram inseridos manualmente”*, para garantir que fique claro que as coordenadas provêm de uma inserção manual, e não do GPS automático e verificável do telefone.
...
:::note
👉🏽 **Dica**:  Para compartilhar os metadados da observação com alguém que esteja auxiliando sua equipe, use ![app-icon-share](assets/a419d3830b128d8df965e5057ab5ad45c01336f9ea2bead41c8ac4a2971ceef4.png) **Compartilhar.**  Escolha entre E-mail e WhatsApp para abrir um rascunho de mensagem formatado, pronto para enviar.
:::
...
Abrir ![down-toggle](assets/b35b1e92faac791f33d53e95647b72bb9970dfb3f28c0e19e429a897532d0c71.png) **Validado pelo CoMapeo** para visualizar detalhes adicionais que indicam a proximidade, em tempo e distância, entre o momento em que a foto foi tirada e o momento em que a observação foi salva. 

[image]

:::note 💡 Dica
**: **Para capturar todas as informações disponíveis em uma única imagem, use a opção, ![android-extend-capture](assets/e032792d505125862bdd6fb70de0c69b6df8b7cd3868d6da3f02b057599ab84a.jpg) e role para baixo, que aparece temporariamente após fazer uma captura de tela.
...
![app-icon-edit](assets/1e513871ec012d90a9f11451bb7284263ceb07cbf1ed7d13991db190473acf23.png) Editar uma observação

![app-icon-delete](assets/17a190b42457d2770b82a1091bb0781e974210318bd801fccb29ac1c3e10ed6a.svg) Deletar uma observação

![app-icon-share](assets/a419d3830b128d8df965e5057ab5ad45c01336f9ea2bead41c8ac4a2971ceef4.png) Compartilhar uma observação

## Conteúdo relacionado

Acesse 🔗** **[Editando uma observação](https://www.notion.so/docs/editing-observation)

Ir para 🔗 [Compartilhamento de uma única observação e metadados](https://www.notion.so/docs/sharing-a-single-observation-and-metadata)

Ir para 🔗 [Solução de problemas: Observações e trilhas](https://www.notion.so/docs/troubleshooting-observations-and-tracks)
...
Acesse 🔗[Solução de problemas: Observações e trilhas](https://www.notion.so/docs/troubleshooting-observations-and-tracks)
