---
id: "solucao-de-problemas-configuracao-e-personalizacao"
title: "Solução de Problemas: Configuração e Personalização"
slug: "/solucao-de-problemas-configuracao-e-personalizacao"
...
custom_edit_url: "https://github.com/digidem/comapeo-docs/edit/main/docs/pt/docs/90-miscellaneous/solucao-de-problemas-configuracao-e-personalizacao.md"
source: notion
notion_page_id: "3131b081-62d5-80f8-b77e-c52b521a9119"
notion_last_edited_time: "2026-04-22T03:58:00.000Z"
content_hash: "sha256:e9023330691c78f13f1a2824d73b12d9de2bfc7694c4fc2bcf5868bf022766d3"
status: draft
locale: pt
...
✅**Verifique se você tem **![comapeo_logo_circle](assets/3a40065bd081188fd54f3a2eea142a94ef06d828f89e0980a51391cb7aa347c9.png)**CoMapeo instalado no seu telefone ou computador. **Siga as instruções em [Instalando o CoMapeo](https://notion.so/docs/installing-comapeo-and-onboarding).
...
### 🟩**Solução: Ver **[Soluções Comuns - 🟩 Solução: Certifique-se de que seu dispositivo tenha espaço livre suficiente disponível](https://notion.so/docs/common-solutions/#solution-make-sure-your-device-has-enough-free-space-available)
...
A única maneira de alterar um nome de dispositivo para uso no CoMapeo é usar esse mesmo dispositivo e acessar ![app-icon-app-settings](assets/2c4335fb69ab490d45c00fa57a40665ffeb87869bd446367c970909f95287356.png) Configurações do CoMapeo → Nome do Dispositivo.
...
Acesse: 🔗[Usando um Código de Acesso do Aplicativo para Segurança](https://notion.so/docs/using-an-app-passcode-for-security)
...
Se você não conseguiu resolver os problemas com os recursos compartilhados nas ![comapeo-docs](assets/0ea453a2d19c6722e498a75251d069c71146a686530c750722b0ac1d5cbb75d1.svg) [Páginas de Ajuda do CoMapeo](https://www.notion.so/docs/introduction), entre em contato conosco. Alguém da Awana Digital terá prazer em receber detalhes sobre sua experiência, incluindo capturas de tela, para ajudar a explicar o que não está funcionando como esperado
📧 Envie-nos um e-mail para [help@comapeo.app](mailto:help@comapeo.app)

💬 Você também pode conversar conosco no ![discord-color-icon](assets/5521cc1569f933e664890dc0bcacc292ffcf07160b08e4d46145d2c8f3928db3.png)** **[Discord](https://discord.gg/kWp34am3)!
:::
