---
id: "criando-uma-nova-observacao"
title: Criando uma Nova Observação
slug: "/criando-uma-nova-observacao"
sidebar_label: Criando uma Nova Observação
pagination_label: Criando uma Nova Observação
custom_edit_url: "https://github.com/digidem/comapeo-docs/edit/main/docs/pt/docs/20-gathering-observations-tracks/criando-uma-nova-observacao.md"
source: notion
notion_page_id: "3131b081-62d5-8067-b23e-cf4db7d63a2e"
notion_last_edited_time: "2026-04-22T03:58:00.000Z"
content_hash: "sha256:ad2eb76a964d98980aff907dbc2d0675044924dee1091321464d6c4c92d82800"
status: draft
locale: pt
...
***Passo 1***: Na visualização do mapa ![app-icon-map](assets/c3a90bf1bbc7f33b79ebc8060e2591c37c754808d7c30e3f9b9c27848ae5c11a.png) ou na visualização da câmera ![app-icon-camera](assets/35a5bc098c0d4459909d7ab43a5ac0ddde5580123495cba9f04f4319646d1629.png), toque no botão ![app-icon-comapeo-add-observation](assets/a29cca65239d48f05dd3abf4db7c83f36eb65cd483866c560554e9638d528329.png) “Adicionar observação” para começar a criar uma nova observação.
...
Role para baixo para explorar a lista completa de categorias ![app-icon-comapeo-all-projects-grid](assets/8f3f0f1d2d6137ee76a443d39e63a3467a35c9c7da5c24b65faa7ceeb0983e5f.png). Toque no ícone da categoria que melhor represente o que você está documentando com essa **Observação**.
...
***Passo 3***:  O editor de observações será exibido, mostrando os dados que serão salvos, incluindo as ![app-icon-coordinates](assets/16ad368673fa5ccbab0930b79526b9168194d8b4af5d94145d2d0d1088a5100b.png) coordenadas GPS. Estas podem mudar se os dados do sensor GPS forem modificados. Recomenda-se aguardar até obter uma boa precisão antes de salvar.

![image](assets/16dffb11d91b23e83bb03e037b92451f94ed14751bb3866220c62f48b5ebac51.png)

---

***Passo 4*****:** Adicione uma descrição, ![app-icon-add-details](assets/14ad843a3b74a9a146c380efc52a647d164ac1007a4af1e43cdcfeb1fa684010.png) [detalhes](#adicionando-detalhes), ![app-icon-comapeo-add-photo](assets/9b0291575046903c7a091b07d7f9c00887ff09acc00b4a27dfe852a73aff7687.png) [fotos](#adicionando-fotos)  e ![app-icon-add-audio](assets/183c1246924bddc32662581dda1c199ab4a3e5786d5a9a9ab636e590861e0978.png) [áudio](#adicionando-áudio) , conforme necessário.

---

***Passo 5***: Toque em ![app-icon-save-observation](assets/638bd525ec54c8194824c12f33fdfd3a0e09d6ca427908c93375286c39f9e9e7.png) **Salvar** para salvar sua observação. Agora ela aparecerá no ![app-icon-map](assets/c3a90bf1bbc7f33b79ebc8060e2591c37c754808d7c30e3f9b9c27848ae5c11a.png) mapa e na ![app-icon-comapeo-project-cards](assets/fa890f05ac62b8e70d4ea529146e19b878a79aa0bd5b35be1c0a217453bf80e8.png)  lista de observações.

🔗 Acesse [Salvar uma observação](#salvar-uma-observação) para mais informações.

:::note ⚠️ Aviso
Se a observação não for salva no local previsto, não há como editar essas informações. Certifique-se de selecionar ![app-icon-save-observation](assets/638bd525ec54c8194824c12f33fdfd3a0e09d6ca427908c93375286c39f9e9e7.png) **Salvar** para criar a observação, ou ![app-icon-close](assets/9d5ae65edf34e1979b81c99b2c64eb327b70ed605242626f279fd4d09a0d847e.png) Fechar para sair sem salvar.
:::
:::
...
Os detalhes também podem ser completados após salvar, usando a ferramenta ![app-icon-edit](assets/1e513871ec012d90a9f11451bb7284263ceb07cbf1ed7d13991db190473acf23.png) **Editar **
...
***Passo 1****:*  No Novo Editor de Observações, toque em ![app-icon-add-details](assets/14ad843a3b74a9a146c380efc52a647d164ac1007a4af1e43cdcfeb1fa684010.png) **Detalhes** na parte inferior 

![image](assets/16dffb11d91b23e83bb03e037b92451f94ed14751bb3866220c62f48b5ebac51.png)

<div class="notion-spacer" aria-hidden="true" role="presentation"></div>

***Passo 2: ***Leia a instrução e responda às primeiras perguntas. As respostas podem ter três formatos predefinidos: ![app-icon-comapeo-details-select-one](assets/f1e5df2a0c44b9a47eba4c7ca40caaf008e3a1a21966d786b599335be5c2c3d8.jpg) Selecione uma opção, ![app-icon-comapeo-details-select-multiple](assets/24584b96a10cc37008e8660a194cab4f918588df00d2e89eb20b8eb01d13276e.jpg) Selecione várias opções ou apenas texto.
...
Lembre-se de tocar em ![app-icon-save-observation](assets/638bd525ec54c8194824c12f33fdfd3a0e09d6ca427908c93375286c39f9e9e7.png) **Salvar** como etapa final.
:::
...
***Passo 2:*** Enquadre a foto e toque em ![app-icon-comapeo-capture-photo](assets/a29cca65239d48f05dd3abf4db7c83f36eb65cd483866c560554e9638d528329.png) para tirar uma foto. 
...
***Passo 2****:* Toque no botão ![app-icon-delete](assets/17a190b42457d2770b82a1091bb0781e974210318bd801fccb29ac1c3e10ed6a.svg) **EXCLUIR FOTO**,

![image](assets/a1fe94131a91355e7e13631ad0c68235492b0e15fbc148420fccabf2d58240d0.png)

***Passo 3****:* Confirme a exclusão clicando em ![app-icon-delete](assets/17a190b42457d2770b82a1091bb0781e974210318bd801fccb29ac1c3e10ed6a.svg) **Excluir foto**.

⚠️ **Aviso**: Uma vez excluídas, as fotos não podem ser recuperadas. Para cancelar a exclusão da foto, toque em **CANCELAR.**  Volte ao Editor de Observações com a seta ![app-icon-go-back](assets/c97adb66b8bbb5445a7a53a580d11d408688ba54d4f44557bb5f7b33911b4484.png) **voltar**.
...
***Passo 1:***** **Selecionar ![app-icon-add-audio](assets/183c1246924bddc32662581dda1c199ab4a3e5786d5a9a9ab636e590861e0978.png) **adicionar áudio**
...
→ ![app-icon-delete](assets/17a190b42457d2770b82a1091bb0781e974210318bd801fccb29ac1c3e10ed6a.svg) **EXCLUIR** o áudio.
...
***Passo 2****:* Toque no botão ![app-icon-delete](assets/17a190b42457d2770b82a1091bb0781e974210318bd801fccb29ac1c3e10ed6a.svg) **EXCLUIR**.
...
Salve uma observação tocando no botão azul ![app-icon-save-observation](assets/638bd525ec54c8194824c12f33fdfd3a0e09d6ca427908c93375286c39f9e9e7.png) no topo da tela. Uma vez que uma observação tenha sido salva, ela aparecerá na lista de observações e na tela do mapa.
...
**Precisão do GPS **é uma propriedade de metadados calculada pelo sensor GPS em um dispositivo. Ela é baseada em informações fornecidas por satélites. Esta informação é exibida no CoMapeo Mobile na tela do mapa e na tela da câmera, à esquerda do botão de captura ![app-icon-gps20](assets/9dba27a9d6b5217674fc683388d592f4a825c79bcfee67c8732ac231d915aa3d.png)![app-icon-comapeo-capture-photo](assets/a29cca65239d48f05dd3abf4db7c83f36eb65cd483866c560554e9638d528329.png). Ele também é exibido nas coordenadas ![app-icon-coordinates](assets/16ad368673fa5ccbab0930b79526b9168194d8b4af5d94145d2d0d1088a5100b.png) na tela **Criar observação** e será atualizado até que a observação seja salva.

Se as ![app-icon-coordinates](assets/16ad368673fa5ccbab0930b79526b9168194d8b4af5d94145d2d0d1088a5100b.png) coordenadas têm uma precisão pior que ±10m ou se não houver sinal de GPS no momento de salvar a observação, o CoMapeo oferece três opções.

![image](assets/456d10a4f1014a34597205ad4c840a7763a1c8477b7da7c5e5bb91e143131353.jpg)

<div class="notion-spacer" aria-hidden="true" role="presentation"></div>

- **Continu****ar esperando **até que o sinal do GPS melhore para obter melhor precisão. O tempo e pequenas manobras no dispositivo geralmente ajudam. Verificar as ![app-icon-coordinates](assets/16ad368673fa5ccbab0930b79526b9168194d8b4af5d94145d2d0d1088a5100b.png)coordenadas até que a precisão seja melhor que ±10m, e tocar em ![app-icon-save-observation](assets/638bd525ec54c8194824c12f33fdfd3a0e09d6ca427908c93375286c39f9e9e7.png) então, impedirá que o aviso do GPS apareça novamente.
...
:::note 💡 Dica
Uma alternativa para validar dados é ![app-icon-comapeo-add-photo](assets/9b0291575046903c7a091b07d7f9c00887ff09acc00b4a27dfe852a73aff7687.png) **adicionar uma foto** à observação das coordenadas e da precisão exibidas em um dispositivo com um sinal de GPS melhor. Faça isso *antes *de você inserir as coordenadas manualmente.
...
💡**Dica: **Para retornar às opções, toque no ![app-icon-go-back](assets/c97adb66b8bbb5445a7a53a580d11d408688ba54d4f44557bb5f7b33911b4484.png) Botão Voltar
...
:::note ⚠️ Aviso
Não há como editar as informações de coordenadas inseridas após ![app-icon-save-observation](assets/638bd525ec54c8194824c12f33fdfd3a0e09d6ca427908c93375286c39f9e9e7.png) salvar.
:::
...
***Passo 4: ***Toque em ![app-icon-save-observation](assets/638bd525ec54c8194824c12f33fdfd3a0e09d6ca427908c93375286c39f9e9e7.png) **Salvar. **A observação é salva com as coordenadas ao mesmo tempo.
:::
