---
id: "entendendo-como-a-troca-funciona"
...
custom_edit_url: "https://github.com/digidem/comapeo-docs/edit/main/docs/pt/docs/60-exchanging-observations/entendendo-como-a-troca-funciona.md"
source: notion
notion_page_id: "2621b081-62d5-8197-a344-ffe20d8a8ecc"
notion_last_edited_time: "2026-04-22T03:58:00.000Z"
content_hash: "sha256:f82cfa7053d86645cc844b7117d0900507a26c56efe34746ac297c23dbe27593"
status: draft
locale: pt
...
Acesse: 🔗[Usando o Exchange offline](https://notion.so/docs/using-exchange-offline)
...
Acesse: 🔗[Ajustando Configurações de Troca](/2381b08162d580e2a5eecae57f6f02ed?p=2621b08162d58197a344ffe20d8a8ecc&pm=s)** **para instruções
:::
...
Acesse: 🔗[Criptografia & Segurança](https://notion.so/docs/encryption-and-security)** **para aprender mais sobre os mecanismos técnicos que tornam a Troca dos dados segura no CoMapeo.
...
Acesse: 🔗[Entendendo Projetos → Múltiplos projetos](https://notion.so/docs/understanding-projects/#multiple-projects)
...
Acesse: 🔗[Criptografia & Segurança](https://notion.so/docs/encryption-and-security)

### **Tendo problemas?**

Acesse: 🔗[Solução de Problemas: Mapeamento com Colaboradores](https://notion.so/docs/troubleshooting-mapping-with-collaborators)
