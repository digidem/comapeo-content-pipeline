---
id: "cambiar-el-conjunto-de-categorias"
title: Cambiar el Conjunto de Categorías
slug: "/cambiar-el-conjunto-de-categorias"
sidebar_label: Cambiar el Conjunto de Categorías
pagination_label: Cambiar el Conjunto de Categorías
custom_edit_url: "https://github.com/digidem/comapeo-docs/edit/main/docs/es/docs/50-managing-projects/cambiar-el-conjunto-de-categorias.md"
source: notion
notion_page_id: "3131b081-62d5-803c-998b-e39b7476de74"
notion_last_edited_time: "2026-04-25T21:08:00.000Z"
content_hash: "sha256:9de0d6dda287d8aa91bf42d5a0fca973028464c8cd7de058f7f12f79dce925a6"
status: draft
locale: es
...
✔️ Herramientas del Coordinador ![app-icon-comapeo-coordinator](assets/77ddbc4137798bed6b6b838cdfc22c990548dd8dc643056e500ffb59b0eb2b1b.png) visibles.

✔️  El dispositivo tiene un rol de Coordinador ![app-icon-comapeo-coordinator](assets/77ddbc4137798bed6b6b838cdfc22c990548dd8dc643056e500ffb59b0eb2b1b.png).
...
***Paso 2: ***Abre CoMapeo ![comapeo-platform](assets/e67891bb2deee359f763589bf2283850bff9acd6208a5cc1e90171070d897de3.png), y en el menú principal, **selecciona el proyecto **dónde se añadirá el nuevo conjunto de categorías.
...
Para revisar el conjunto de categorías incluido en CoMapeo desde la propia aplicación, sigue los pasos para [crear una observación](/docs/crea-una-nueva-observacion), [añadir detalles](/docs/crea-una-nueva-observacion#agregar-detalles) y eliminar las observaciones guardadas como parte de la exploración.
...
Ve a 🔗 [Invitar a colaboradores](/docs/invita-colaboradores) para obtener instrucciones

<div class="notion-spacer" aria-hidden="true" role="presentation"></div>

## Contenido relevante

Ir a 🔗 [Crea un Conjunto de Categorías personalizadas](/docs/crea-un-conjunto-de-categorías-personalizadas)
...
Ir a 🔗 [Solución de problemas](/category/solucion-de-problemas)[ → changing categories set](/docs/troubleshooting-mapping-with-collaborators#project-setting-problems)** **
