---
id: "conoce-como-funciona-el-intercambio"
title: Conoce cómo funciona el Intercambio
slug: "/conoce-como-funciona-el-intercambio"
sidebar_label: Conoce cómo funciona el Intercambio
pagination_label: Conoce cómo funciona el Intercambio
custom_edit_url: "https://github.com/digidem/comapeo-docs/edit/main/docs/es/docs/60-exchanging-observations/conoce-como-funciona-el-intercambio.md"
source: notion
notion_page_id: "2621b081-62d5-81bf-a9ec-d80bc77bae17"
notion_last_edited_time: "2026-04-24T20:25:00.000Z"
content_hash: "sha256:d64196ecdd6a602ebb2c9e9ce92b403bb0c6ef9ee6dd515c99ab219350560f13"
status: draft
locale: es
...
Ve a 🔗 [Encriptación y Seguridad](/docs/encriptacion-y-seguridad) para obtener más información sobre los mecanismos técnicos que garantizan la seguridad del Intercambio en CoMapeo.
...
Ir a 🔗 [Comprende las Bases Sobre Proyectos](/docs/comprende-las-bases-sobre-proyectos)[ → Varios proyectos](https://www.notion.so/docs/understanding-projects/#multiple-projects)
...
Ir a 🔗 [Encriptación y Seguridad](/docs/encriptacion-y-seguridad)

### ¿Tienes problemas?

Ir a 🔗 [Solución de Problemas: Mapeo con Colaboradores](/docs/solucion-de-problemas-mapeo-con-colaboradores)

Ir a 🔗 [Solución de Problemas: Mapeo con Colaboradores ](/docs/solucion-de-problemas-mapeo-con-colaboradores)[-> Exchange Problems](/docs/troubleshooting-mapping-with-collaborators#exchange-problems)** **
